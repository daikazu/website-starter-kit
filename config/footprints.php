...
return [
    ...
    */
    ...
    |
    */
    'model' => \Tjmpromos\MasterForms\Models\FormSubmissions::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The column that defines the relation between tracked visits and the model.
    |
    */
    'column_name' => 'user_id',
    ...
    */
    ...
    |
    */
    'tracking_filter' => \Tjmpromos\Footprints\TrackingFilter::class,
    ...
    |
    */
    'tracking_logger' => \Tjmpromos\Footprints\TrackingLogger::class,
    ...
    |--------------------------------------------------------------------------
    |
    | This class is responsible for generating a digital footprint (string) of
    ...
    |
    */
    'footprinter' => \Tjmpromos\Footprints\Footprinter::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Determine if the users IP address should be longed or not.
    |
    */
    ...
    */
    ...
    | you have to set this to .your-domain.com
    |
    */
